...
func (m *messagesCmp) help() string {
	...
	text += lipgloss.JoinHorizontal(
		...
		baseStyle.Foreground(t.TextMuted()).Bold(true).Render(" | "),
		baseStyle.Foreground(t.Text()).Bold(true).Render("ctrl+f"),
		baseStyle.Foreground(t.TextMuted()).Bold(true).Render(" image"),
		baseStyle.Foreground(t.TextMuted()).Bold(true).Render(" | "),
		baseStyle.Foreground(t.Text()).Bold(true).Render("ctrl+y"),
		baseStyle.Foreground(t.TextMuted()).Bold(true).Render(" paste image"),
		baseStyle.Foreground(t.TextMuted()).Bold(true).Render(" | "),
		baseStyle.Foreground(t.Text()).Bold(true).Render("ctrl+v"),
		baseStyle.Foreground(t.TextMuted()).Bold(true).Render(" paste"),
		baseStyle.Foreground(t.TextMuted()).Bold(true).Render(" | "),
